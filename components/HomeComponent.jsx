...
import { FaCloudUploadAlt, FaCamera, FaArrowRight, FaGraduationCap, FaBrain, FaBook, FaLightbulb, FaStar, FaRocket, FaQuestionCircle, FaCrown, FaCheck, FaMagic, FaArrowLeft } from 'react-icons/fa';
    ...
    try {
      ...
      setTimeout(() => {
        if (selectedFormat === 'memo') {
          ...
          router.push(`/my-qcm/${data.quizId}`);
        }
      }, 1000);
