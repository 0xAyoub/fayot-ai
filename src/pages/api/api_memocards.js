...
async function generateMemocardsFromDocument(fileBuffer, fileName, numberOfCards, difficultParts = '') {
  try {
    console.log(`Génération de mémocartes à partir du document: ${fileName}`);
